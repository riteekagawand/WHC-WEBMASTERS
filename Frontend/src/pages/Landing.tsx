...
import { FiSearch } from "react-icons/fi"; // For search and user icons
	...
	return (
		<div className="min-h-screen flex flex-col bg-gray-100">
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
					...
					<div className="flex items-center justify-between space-x-3">
						...
						<div className="flex items-center space-x-3">
							...
							<button
								type="button"
								className="w-8 h-8 bg-purple-600 text-black rounded-full flex items-center justify-center"
							>
								S
							</button>
						</div>
					...
					<div className="max-w-7xl mt-[-60px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center">
						...
						<div className="text-center mt-20 md:text-left mb-8 md:mb-0">
							...
							<p className="mt-4 text-md text-gray-600 mb-6">
								Join a vibrant community of women who inspire, support, and grow
								together. Discover resources, stories, and tools to help you
							...
							<div className="flex justify-center md:justify-start space-x-2">
								...
								<Link to="/login">
									<button
										type="button"
										className="mt-2 px-8 py-3 text-white font-semibold bg-gradient-to-r from-violet-950 to-violet-900 text-black rounded-full shadow-md hover:from-purple-800 hover:to-purple-600"
									>
										Get Started
									</button>
								</Link>
			...
			<div className="flex flex-col md:flex-row items-center max-w-6xl mx-auto p-6 md:p-12">
				...
				<div className="w-full md:w-1/2 md:pl-12 mt-6 md:mt-0">
					...
					<p className="text-gray-600 mt-7 text-lg">
						A digital space designed to empower women entrepreneurs to easily
						create, manage, and grow their online businesses.
						<br />
						<br /> We believe in breaking down the technical barriers that often
						hinder women from establishing a strong digital presence.
					</p>
				</div>
			</div>

			<div
				className="flex mx-56 items-center min-h-screen mt-1 bg-right"
				style={{
				...
				<div className="w-full p-6 flex flex-col md:flex-row justify-between relative">
					...
					<div className="w-full md:w-1/2 mt-32 text-left">
						...
						<p className="text-gray-600 mt-8">
							We empower your business with seamless digital tools, innovative
							features, and insights that drive growth and elevate your brand to
							new heights.
						</p>
					</div>
						...
						{[
							{
								...
								description:
									"Your ultimate business partner, packed with powerful tools and features",
								icon: <FaLightbulb className="w-10 h-10 text-violet-500" />,
							},
							{
								title: "Market For You",
								description:
									"Boost your brand's visibility, reach a wider audience",
								icon: <FaWallet className="w-10 h-10 text-violet-500" />,
							},
							{
								title: "Develop For You",
								description:
									"Let's you create a stunning website without any coding",
			...
			<div className="w-full h-[500px] flex items-center justify-center max-w-[90%] mx-auto ">
				<img src={mask} alt="" className="w-full h-auto object-contain ml-8" />
			</div>
			...
			<div className="w-full  flex items-center justify-center py-12">
				...
				<div className="max-w-7xl w-full mx-auto px-6 py-8 bg-white bg-opacity-80 rounded-3xl shadow-lg flex flex-col md:flex-row items-center justify-between">
					...
					<form className="flex items-center space-x-3">
						...
						<Link
							to="/login"
							className="px-6 py-2 text-white font-semibold bg-gradient-to-r from-violet-950 to-violet-900 text-black rounded-full shadow-gray-400 shadow-md hover:from-purple-800 hover:to-purple-600"
						>
							Sign Up
						</Link>
					</form>
