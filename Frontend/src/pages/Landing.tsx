						...
						<div className="text-center mt-20 md:text-left mb-8 md:mb-0">
							...
							<div className="flex justify-center md:justify-start space-x-2">
								...
								<Link to="/login">
									<button
										type="button"
										className="mt-2 px-8 py-3 font-semibold bg-gradient-to-r from-violet-950 to-violet-900 text-black rounded-full shadow-md hover:from-purple-800 hover:to-purple-600"
									>
										Get Started
									</button>
								</Link>
