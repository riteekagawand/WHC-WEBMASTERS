...
import SiddhiHateSVG from "../assets/frame-3.svg";
          ...
          <div className="max-w-7xl mt-[-60px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center">
            <div className="text-center mt-20 md:text-left mb-8 md:mb-0">
              ...
              <p className="mt-4 text-md text-gray-600 mb-6">
                ...
                together. Discover resources, stories, and tools to help you thrive
              ...
              <div className="flex justify-center md:justify-start space-x-2">
                <Link to="/login">
                  <button
                    type="button"
                    className="mt-2 px-8 py-3 text-white font-semibold bg-gradient-to-r from-violet-950 to-violet-900 rounded-full shadow-md hover:from-purple-800 hover:to-purple-600"
                  >
                    Get Started
                  </button>
                </Link>
      ...
      <div className="w-full flex items-center justify-center py-12">
        <div className="max-w-7xl w-full mx-auto px-6 py-8 bg-white bg-opacity-80 rounded-3xl shadow-lg flex flex-col md:flex-row items-center justify-between">
          ...
          <form className="flex items-center space-x-3">
            ...
            <Link
              to="/login"
              className="px-6 py-2 text-white font-semibold bg-gradient-to-r from-violet-950 to-violet-900 rounded-full shadow-gray-400 shadow-md hover:from-purple-800 hover:to-purple-600"
            >
              Sign Up
            </Link>
          </form>
