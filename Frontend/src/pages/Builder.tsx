	...
	const popularTemplates = [
		{
			...
			description: "Clean, minimal design for showcasing your work",
			icon: RiLayout5Line,
		},
		{
			title: "Business Pro",
			description: "Professional layout for small businesses and startups",
			icon: BsBuildings,
		},
		{
			title: "Online Store",
			description: "E-commerce ready template with product galleries",
			icon: LuShoppingBag,
		},
		{
			title: "Blog Standard",
			description: "Content-focused layout for writers and creators",
			icon: CgNotes,
		},
	];
	...
	const recentlyAdded = [
		{
			...
			description: "Showcase your dishes with this elegant food menu template",
			icon: RiRestaurantFill,
		},
		{
			title: "Fitness Coach",
			description: "Perfect for personal trainers and fitness professionals",
			icon: IoMdFitness,
		},
		{
			title: "Photography",
			description:
				"Showcase your visual portfolio with this gallery-focused template",
			icon: IoCameraOutline,
		},
		{
			title: "Event Landing",
			description:
				"Promote your upcoming events with this conversion-optimized layout",
