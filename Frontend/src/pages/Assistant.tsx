  ...
  const popularTools = [
    {
      ...
      description: 'Get insights on market trends, competitor analysis, and growth opportunities',
      icon: MdOutlineQueryStats,
    },
    {
      title: 'Content Generator',
      description: 'Create engaging blog posts, social media content, and product descriptions',
      icon: GoPencil,
    },
    {
      title: 'Customer Service Support',
      description: 'Automate responses to common customer inquiries and save time',
  ...
  const recommendations = [
    {
      ...
      description: 'Generate sales predictions based on your historical data and market trends',
      icon: TfiStatsUp,
    },
    {
      title: 'Marketing Ad Copy Writer',
      description: 'Create compelling ad copy for your digital marketing campaigns',
      icon: TbSpeakerphone,
    },
    {
      title: 'Strategy Business Advisor',
      description: 'Get personalized and strategic advice to grow your business',
      icon: FaChartBar,
    },
    {
      title: 'Global Tool',
      description: 'Translate your content into multiple languages for global markets',
      icon: FaGlobe,
    },
  ];

  const tabs = ['All', 'Tools', 'Business Insights', 'Content Creator', 'Customer Support', 'Saved'];
  ...
  return (
    <div className="p-6 min-h-screen">
      ...
      <div className="flex justify-between items-center mb-10">
        <div>
          <h1 className="text-3xl font-bold text-gray-800">AI Business Assistant</h1>
          <p className="text-gray-600 mt-8">
            Get business recommendations, content suggestions, and automated customer support
          </p>
        </div>
      ...
      {/* Popular AI Tools */}
      <div className="mt-8">
        <h2 className="text-xl font-semibold text-gray-800 mb-4">Popular AI Tools</h2>
