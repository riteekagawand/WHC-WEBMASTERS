      ...
      <div className="flex flex-col lg:flex-row gap-6 mb-10">
        ...
        <div className="flex-1">
          ...
          <div className="relative">
            <input
              ...
              className="w-full p-4 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 text-gray-800 placeholder-gray-400 shadow-sm transition-all duration-300"
            />
        ...
        <div className="flex-1">
          ...
          <div className="relative">
            <select
              ...
              className="w-full p-4 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 appearance-none text-gray-800 placeholder-gray-400 shadow-sm transition-all duration-300"
            >
        ...
        <div className="flex items-end">
          <button
            ...
            disabled={isLoading}
            className={` text-2xl bg-gradient-to-r from-purple-600 to-indigo-600 text-white font-semibold py-3 px-7 rounded-xl transition-all duration-300 shadow-md ${
              isLoading ? 'opacity-50 cursor-not-allowed' : 'from-violet-700 to-indigo-700 hover:shadow-lg'
            }`}
          >
