...
const PortfolioBuilder = () => {
    ...
    useEffect(() => {
      window.scrollTo(0, 0);
      document.title = `HerSpace | Template | Business Pro`;
  ...
  <div>
          <header class="text-gray-600 body-font">
            <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
              <a class="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
                ...
                <span class="ml-3 text-xl">BusinessPro</span>
              </a>
            ...
            <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
              <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">
                  Grow Your Business 
                  <br class="hidden lg:inline-block"/>with BusinessPro
                </h1>
                <p class="mb-8 leading-relaxed">
                  Empower your small business or startup with our professional solutions. From strategic planning to digital marketing, we provide the tools and expertise you need to succeed in today’s competitive market. Let’s take your business to the next level.
                </p>
              ...
              <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 bg-transparent">
                <img alt="hero" class="object-cover w-full h-full filter-none" src="https://via.placeholder.com/500x300?text=Business+Hero+Image"/>
              </div>
            </div>
          </section>
          ...
          <section class="text-gray-600 body-font">
            <div class="container px-5 py-24 mx-auto">
              <div class="flex flex-col text-center w-full mb-20">
                ...
                <p class="lg:w-2/3 mx-auto leading-relaxed text-base text-gray-500">Comprehensive solutions to help your business thrive.</p>
              </div>
              <div class="flex flex-wrap -m-4">
                <div class="p-4 md:w-1/3">
                  <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                    <img class="lg:h-48 md:h-36 w-full object-cover object-center" src="https://via.placeholder.com/300x200?text=Business+Consulting" alt="Business Consulting"/>
                    <div class="p-6">
                      <h2 class="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">SERVICE</h2>
                      <h1 class="title-font text-lg font-medium text-gray-900 mb-3">Business Consulting</h1>
                      <p class="leading-relaxed mb-3">Expert guidance to develop strategies for growth and efficiency.</p>
                ...
                <div class="p-4 md:w-1/3">
                  <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                    <img class="lg:h-48 md:h-36 w-full object-cover object-center" src="https://via.placeholder.com/300x200?text=Digital+Marketing" alt="Digital Marketing"/>
                    <div class="p-6">
                      <h2 class="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">SERVICE</h2>
                      <h1 class="title-font text-lg font-medium text-gray-900 mb-3">Digital Marketing</h1>
                      <p class="leading-relaxed mb-3">Boost your online presence with tailored marketing campaigns.</p>
                      <div class="flex items-center flex-wrap">
                        <a class="text-indigo-500 inline-flex items-center md:mb-2 lg:mb-0">Learn More
                          <svg class="w-4 h-4 ml-2" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path d="M5 12h14"></path>
                ...
                <div class="p-4 md:w-1/3">
                  <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                    <img class="lg:h-48 md:h-36 w-full object-cover object-center" src="https://via.placeholder.com/300x200?text=Web+Development" alt="Web Development"/>
                    <div class="p-6">
                      <h2 class="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">SERVICE</h2>
                      <h1 class="title-font text-lg font-medium text-gray-900 mb-3">Web Development</h1>
                      <p class="leading-relaxed mb-3">Build a professional website to showcase your business.</p>
                      <div class="flex items-center flex-wrap">
                        <a class="text-indigo-500 inline-flex items-center md:mb-2 lg:mb-0">Learn More
                          <svg class="w-4 h-4 ml-2" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path d="M5 12h14"></path>
          ...
          <section class="text-gray-600 body-font">
            <div class="container px-5 py-24 mx-auto">
              <div class="flex flex-col text-center w-full mb-20">
                <h1 class="sm:text-4xl text-3xl font-medium title-font mb-2 text-gray-900">About Us</h1>
                <p class="lg:w-2/3 mx-auto leading-relaxed text-base text-gray-500">Learn more about our mission and values.</p>
              </div>
              <div class="flex flex-wrap -m-4">
                <div class="p-4 md:w-1/2">
                  <div class="h-full flex flex-col items-center text-center">
                    <img alt="team" class="flex-shrink-0 rounded-lg w-full h-56 object-cover object-center mb-4" src="https://via.placeholder.com/500x300?text=Our+Team"/>
                    <div class="w-full">
                      <h2 class="title-font font-medium text-lg text-gray-900">Our Team</h2>
                      <p class="mb-4">We’re a dedicated team of professionals passionate about helping small businesses succeed.</p>
                    </div>
                  </div>
                </div>
                <div class="p-4 md:w-1/2">
                  <div class="h-full flex flex-col items-center text-center">
                    <img alt="mission" class="flex-shrink-0 rounded-lg w-full h-56 object-cover object-center mb-4" src="https://via.placeholder.com/500x300?text=Our+Mission"/>
                    <div class="w-full">
                      <h2 class="title-font font-medium text-lg text-gray-900">Our Mission</h2>
                      <p class="mb-4">To empower startups and small businesses with the tools and strategies they need to grow.</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <section class="text-gray-600 body-font">
            <div class="container px-5 py-24 mx-auto">
              <div class="flex flex-col text-center w-full mb-20">
                <h1 class="sm:text-4xl text-3xl font-medium title-font mb-2 text-gray-900">What Our Clients Say</h1>
                <p class="lg:w-2/3 mx-auto leading-relaxed text-base text-gray-500">Hear from businesses we’ve helped grow.</p>
              </div>
              <div class="flex flex-wrap -m-4">
                <div class="p-4 md:w-1/3">
                  <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden p-6">
                    <p class="leading-relaxed mb-3">"BusinessPro helped us streamline our operations and grow our customer base. Highly recommend!"</p>
                    <div class="flex items-center">
                      <div class="w-10 h-10 rounded-full bg-indigo-500 text-white flex items-center justify-center">AL</div>
                      <div class="ml-4">
                        <p class="text-gray-900 font-medium">Alice Lee</p>
                        <p class="text-gray-500 text-sm">Founder, TechStartup</p>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="p-4 md:w-1/3">
                  <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden p-6">
                    <p class="leading-relaxed mb-3">"Their digital marketing services took our online presence to the next level. Amazing results!"</p>
                    <div class="flex items-center">
                      <div class="w-10 h-10 rounded-full bg-indigo-500 text-white flex items-center justify-center">RS</div>
                      <div class="ml-4">
                        <p class="text-gray-900 font-medium">Robert Smith</p>
                        <p class="text-gray-500 text-sm">Owner, Local Bakery</p>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="p-4 md:w-1/3">
                  <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden p-6">
                    <p class="leading-relaxed mb-3">"The website they built for us is professional and user-friendly. Our clients love it!"</p>
                    <div class="flex items-center">
                      <div class="w-10 h-10 rounded-full bg-indigo-500 text-white flex items-center justify-center">EK</div>
                      <div class="ml-4">
                        <p class="text-gray-900 font-medium">Emma Kim</p>
                        <p class="text-gray-500 text-sm">CEO, Consulting Firm</p>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <section class="text-gray-600 body-font relative">
            <div class="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
              <div class="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
                <iframe frameborder="0" width="100%" height="100%" title="map" marginheight="0" marginwidth="0" scrolling="no" src="https://maps.google.com/maps?width=100%25&height=600&hl=en&q=San+Francisco&ie=UTF8&t=&z=14&iwloc=B&output=embed" class="absolute inset-0"></iframe>
                <div class="bg-white relative flex flex-wrap py-6 rounded shadow-md">
                  <div class="lg:w-1/2 px-6">
                    <h2 class="title-font font-semibold text-gray-900 tracking-widest text-xs">ADDRESS</h2>
                    <p class="mt-1">
                      <strong>BusinessPro HQ</strong><br/>
                  ...
                  <div class="lg:w-1/2 px-6 mt-4 lg:mt-0">
                    ...
                    <a class="text-indigo-500 leading-relaxed">info@businesspro.com</a>
                    <h2 class="title-font font-semibold text-gray-900 tracking-widest text-xs mt-4">PHONE</h2>
                    <p class="leading-relaxed">1-800-555-6789</p>
                  </div>
                </div>
              </div>
              <div class="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
                <form>
                  ...
                  <p class="leading-relaxed mb-5 text-gray-600">Let’s discuss how we can help your business grow.</p>
          ...
          <footer class="text-gray-600 body-font">
            <div class="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
              ...
              <p class="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">
                © 2025 BusinessPro —
                <a href="https://twitter.com/businesspro" rel="noopener noreferrer" target="_blank" class="text-gray-600 ml-1">@businesspro</a>
              </p>
