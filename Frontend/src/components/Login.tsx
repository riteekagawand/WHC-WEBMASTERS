			...
			>
				<TabsList className="grid w-full grid-cols-2">
					<TabsTrigger
						...
						className={
							activeTab === "login"
								? "bg-gradient-to-r from-violet-950 to-violet-900 text-white"
								: ""
						}
					>
						Login
				...
				<TabsContent value="login">
					<Card className="border border-gray-200 bg-gradient-to-r from-violet-100 to-blue-100">
						<CardHeader>
							<CardTitle className="font-bold text-3xl">
								Welcome <span className=" text-purple">User</span>
							</CardTitle>
							<CardDescription>
								Ready to elevate your business? Let's build your online presence
								together.
							</CardDescription>
						</CardHeader>
				...
				<TabsContent value="signup">
					<Card className="border border-gray-200 bg-gradient-to-r from-violet-100 to-violet-200">
						<CardHeader>
							<CardTitle className="font-bold text-3xl">
								Join <span className="text-purple">Her Space</span>
							</CardTitle>
							<CardDescription>
								Start growing your business today. Create your personalized
								digital platform.
							</CardDescription>
						</CardHeader>
						<CardContent className="space-y-2">
